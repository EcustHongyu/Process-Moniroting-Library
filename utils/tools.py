...
def find_kde(input, confidence=0.95):
    ...
    Parameters
    ----------
    input: one-dimensional ndarray data
    confidence: The parameter Confidence is the confidence level, which is generally above 0.9
    
    Returns
    -------
    Specific value of control limit
    """
    plt.figure()
